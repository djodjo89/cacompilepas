...
class ProposalList extends React.Component<{ proposals: [] }, any> {
    ...
    public render(): ReactNode {
        return (
            <div
                className={'proposal-section col-lg-7 col-sm-10 mt-sm-2 ml-lg-5 ml-sm-0 pt-sm-1 pl-lg-5 pl-sm-4 position-absolute'}
            >
                <div
                    className={'rounded proposal-list mt-sm-5 ml-lg-5 pt-2 pl-lg-2 pb-1'}
                >
                    <ul
