    ...
    public render(): ReactNode {
        return (
            <section className="col-lg-6 col-sm-6 pr-sm-0 top-section">
                ...
                <p className="ml-lg-2 ml-sm-1 course-sheet-presentation w-100">Le Lorem Ipsum est simplement du faux
                    texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux
                    texte standard de l'imprimerie depuis les années 1500, quand un imprimeur anonyme assembla ensemble
                    des morceaux de texte pour réaliser un livre spécimen de polices de texte.Le Lorem Ipsum est
                    simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem
                    Ipsum est le faux texte standard de l'imprimerie depuis les années 1500, quand un imprimeur anonyme
                    assembla ensemble des morceaux de texte pour réaliser un livre spécimen de polices de texte.Le Lorem
                    Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression.
                    Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500, quand un imprimeur
                    anonyme assembla ensemble des morceaux de texte pour réaliser un livre spécimen de polices de
                    texte.</p>
                <Divider/>
            </section>
        )
...
class Messages extends React.Component {
    ...
    public renderMessage(key: string): ReactNode {
    ...
    public renderMessages(): ({} | null | undefined)[] {
        let res = [];
        for (let i = 0; i < 10; i++)
            res.push(this.renderMessage(i.toString()));
        return res;
    }
            ...
            <li className="col-lg-11 ml-lg-0 ml-sm-0 mt-lg-5 mt-sm-3 mb-lg-5 mb-sm-5">
                <div className="row col-lg-12 col-sm-12 pl-sm-0">
                    <img src={userIcon} className="App-logo col-lg-1 col-sm-1 pr-lg-0 pr-sm-0 pl-lg-0 pl-sm-0"
                         alt="logo"/>
                    <h4 className="col-sm-9 offset-sm-1 mb-sm-0 pl-sm-0 mt-sm-4 ml-lg-2 ml-sm-4">Bidule, le 17 Novembre
                        2019</h4>
                </div>
                <div className="row col-lg-12 col-sm-12 ml-lg-4">
                    <p className="col-lg-12 col-sm-10 offset-lg-0 offset-sm-1 message-body mt-sm-0 pl-sm-2">Le Lorem
                        Ipsum est simplement du faux texte employé dans la composition et la mise en page avant
                        impression.</p>
                </div>
            </li>
        )
...
class CourseSheets extends React.Component {
    ...
    public renderCourseSheet(key: string): ReactNode {
    ...
    public renderCourseSheets(): ({} | null | undefined)[] {
        let res = [];
        for (let i = 0; i < 10; i++)
            res.push(this.renderCourseSheet(i.toString()));
        return res;
    }
            ...
            <div className="course-sheet-card row mt-5">
                ...
                <div className="col-lg-10">
                    ...
                    <div className="course-sheet-presentation ml-lg-1">
                        <p className="course-sheet-description">Le Lorem Ipsum est simplement du faux texte employé dans
                            la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte
