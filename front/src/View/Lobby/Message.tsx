            ...
            <li className="col-lg-11 ml-lg-0 ml-sm-0 mt-lg-5 mt-sm-3 mb-lg-5 mb-sm-5">
                <div className="row col-lg-12 col-sm-12 pl-sm-0">
                    <img src={userIcon} className="App-logo col-lg-1 col-sm-1 pr-lg-0 pr-sm-0 pl-lg-0 pl-sm-0"
                         alt="logo"/>
                    <h4 className="col-sm-9 offset-sm-1 mb-sm-0 pl-sm-0 mt-sm-4 ml-lg-2 ml-sm-4">{this.props.pseudo}, le {this.props.send_date.split(/-/)[2]} {Month[+this.props.send_date.split(/-/)[1]]} {this.props.send_date.split(/-/)[0]}</h4>
                </div>
