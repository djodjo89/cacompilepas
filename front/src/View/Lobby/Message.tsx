        ...
        return (
            <li className="col-lg-11 ml-lg-0 ml-sm-0 mt-lg-5 mt-sm-3 mb-lg-5 mb-sm-5">
                <div className="row col-lg-12 col-sm-12 pl-sm-0">
                    ...
                    <h4 className="col-lg-9 col-md-9 col-sm-9 col-xs-9 offset-lg-1 offset-md-1 offset-sm-1 offset-xs-1 pt-lg-2 pt-md-2 pt-sm-2 pt-xs-2 pl-lg-0 pl-md-0 pl-sm-0 pl-xs-0 mb-sm-0 mt-lg-4 mt-md-4 mt-sm-4 mt-xs-4 ml-lg-2 ml-sm-4">{this.props.pseudo}, le {this.props.send_date.split(/-/)[2]} {Month[parseInt(this.props.send_date.split(/-/)[1]) - 1]} {this.props.send_date.split(/-/)[0]}</h4>
                </div>
