    ...
    return (
      <nav className="row mt-3">
        <div className="col-lg-2 col-sm-4 mr-lg-0 mr-sm-0">
          <Link id='home-icon' className='glyphicon glyphicon-home col-lg-1 col-sm-2 pl-lg-0 pl-lg-0 pf-sm-0 mr-lg-4 mr-sm-4' to='/' content=''/>
          <div id="home-link" className="mt-1 col-lg-1 col-sm-2 pl-lg-1 pl-sm-2 ml-lg-0"><Link to='/' content='caCompilePas'/></div>
        </div>
        ...
        <Link id="user" className="glyphicon glyphicon-user col-lg-1 col-sm-2 mt-1 offset-lg-1 pr-lg-5 pr-sm-1" to='/connection/login' content=''/>
      </nav>
    )
  }
}
